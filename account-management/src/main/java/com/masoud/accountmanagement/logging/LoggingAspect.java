package com.masoud.accountmanagement.logging;
...
public class LoggingAspect {
    ...
    @Pointcut("within(com.masoud.accountmanagement.repository..*)" +
            " || within(com.masoud.accountmanagement.service..*)" +
            " || within(com.masoud.accountmanagement.rest..*)")
    ...
    @AfterThrowing(pointcut = "applicationBeanPointcut() && springBeanPointcut()", throwing = "e")
